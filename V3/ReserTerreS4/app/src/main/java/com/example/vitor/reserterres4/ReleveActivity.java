...
public class ReleveActivity extends AppCompatActivity {
    ...
    public void fillFields(){
        ...
        association.setText("Association : "+associationStr);
        creneau.setText("Creneau : "+creneauStr);
    ...
    public void validation(){
        ...
        if (invalidData) {
            ...
            String caseeff = "false";
            String caseobs = "false";
            ...
            //inserer dans la bd
            background(effH,effF,lvl,retardStr,observationStr, caseeff, caseobs, associationStr);
    ...
    public void background(String effH,String effF,String lvl,String retard,String obs, String caseeff, String caseobs, String assoc) {
        String type ="fillDb";
        BackgroundWorker backgroundWorker = new BackgroundWorker(this);
        try {
            String res = backgroundWorker.execute(type, effH, effF, lvl, retard, obs,idAgent,gym, caseeff, caseobs, assoc).get();
            Log.i("KEK", res);
        } catch (InterruptedException e) {
            e.printStackTrace();
        } catch (ExecutionException e) {
